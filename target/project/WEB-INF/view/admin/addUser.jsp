...
<body class="hold-transition skin-black light-sidebar sidebar-mini">
	<x:form action="saveuser" method="post" modelAttribute="userVo"
												...
												<div class="row">
													<div class="col-12">
														<div class="form-group">
															...
															<div class="controls">
																<x:input path="userName" name="text"
														...
														<div class="form-group">
															...
															<div class="controls">
																<x:input path="phoneNumber" name="onlyNum"
																	class="form-control" required="required"
														...
														<div class="form-group">
															<h5>
																Meter Serial Number <span class="text-danger">*</span>
															</h5>
															<div class="controls">
																<x:input path="meterNumber" class="form-control"
																	required="required"
																	data-validation-required-message="This field is required" />
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="controls">
																<x:select path="cityVo.id" id="select"
														...
														<div class="form-group">
															...
															<div class="controls">
																<x:select path="areaVo.id" id="select"
																	required="required" class="form-control">
