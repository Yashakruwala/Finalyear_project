...
<header class="main-header">
	<div class="p-10 clearfix float-left logo-block">
		...
		<!-- Logo -->
		<a href="index" class="logo"> <!-- logo--> <span
			class="logo-lg"> <img
				src="<%=request.getContextPath() %>/adminResources/image/logo-light-text.png"
				alt="logo" class="light-logo"> <img
				src="<%=request.getContextPath() %>/adminResources/image/logo-dark-text.png"
					...
					<ul class="dropdown-menu scale-up">
						...
						<li class="user-body"><a class="dropdown-item"
							href="javascript:void(0)"><i class="ion ion-person"></i> My
								Profile</a> <a class="dropdown-item" href="/logout"><i
								class="ion-log-out"></i> Logout</a></li>
					</ul></li>
